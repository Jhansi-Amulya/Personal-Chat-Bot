...
st.markdown('<h1 class="chat-font">🤖  Jhansi Amulya Clone Chatbot</h1>', unsafe_allow_html=True)
st.markdown('<h3 class="chat-font">Ask me anything, and I\'ll respond as Amulya!</h3>', unsafe_allow_html=True)
st.markdown("---")
...
def generate_refined_answer(query, retrieved_answer):
    prompt = f"""You are Amulya, an AI, ML, and DL instructor. Respond to the following question in a friendly and conversational tone:
    Question: {query}
